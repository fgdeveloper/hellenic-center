...
?>
    ...
    <div class="navigation-tree-container">        
        <?php dcf_naviTree($post->ID, 0, 'Author: '.$authorinfo->display_name); ?> 
    </div>
    ...
    <div id="content">
        ...
        <?php 
            ...
            echo '<h1>'.'Author: '.$authorinfo->display_name.'</h1>';
            
            if($authorinfo->description != '')
            {
                echo '<div style="margin-bottom:20px;">'.$authorinfo->description.'</div>';
            }    
