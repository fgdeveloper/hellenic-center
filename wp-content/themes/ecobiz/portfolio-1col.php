                ...
                <div class="portfolio-blockimg">
                  <div class="portfolio-imgbox1">
                    <div class="<?php if ($portfolio_type == "image") echo 'zoom'; else echo 'play';?>">
                      ...
                      <a href="<?php echo ($pf_link) ? $pf_link : thumb_url();?>" rel="prettyPhoto" title="<?php the_title();?>"><img src="<?php echo get_template_directory_uri();?>/timthumb.php?src=<?php echo thumb_url();?>&amp;h=182&amp;w=424&amp;zc=1" class="boximg-pad2 fade" alt="" /></a>
                      <?php } ?>
                    </div>
                  </div>
                </div>
