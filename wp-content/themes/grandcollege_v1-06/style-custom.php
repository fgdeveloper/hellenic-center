...
div.blog-item-holder .blog-item2 .blog-date-wrapper{  
	background-color: <?php echo get_option(THEME_SHORT_NAME.'_post_date_background', '#65a1bd'); ?> !important;
	color: <?php echo get_option(THEME_SHORT_NAME.'_post_date_text_color', '#fff'); ?> !important;
}
...
.navigation-wrapper .sf-menu .current-menu-item a:hover{
	color: <?php echo get_option(THEME_SHORT_NAME.'_main_navigation_text_hover', '#ededed'); ?> !important;
} 
...
.navigation-wrapper .sf-menu .current-menu-item a{
	color: <?php echo get_option(THEME_SHORT_NAME.'_main_navigation_text_current', '#ededed'); ?> !important;
 }
