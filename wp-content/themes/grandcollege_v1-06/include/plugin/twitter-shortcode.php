<?php
	...
	function twitter_feed($atts, $content = null){
		...
		<script type="text/javascript" src="http://api.twitter.com/1/statuses/user_timeline/<?php echo $user;?>.json?callback=gdl_twitter_callback&count=<?php echo $limit;?>"></script>
