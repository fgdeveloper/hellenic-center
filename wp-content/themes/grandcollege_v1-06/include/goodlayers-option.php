	...
	*/
	...
	$goodlayers_menu = array(			
		...
		__('Overall Elements', 'gdl_back_office') => array(
			...
			__('Footer Slide Show', 'gdl_back_office')=>'gdl_panel_footer_slide_show'),
		...
		__('Elements Color', 'gdl_back_office') => array(
			...
			__('Search', 'gdl_back_office')=>'gdl_panel_top_search',
			__('Body', 'gdl_back_office')=>'gdl_panel_body',
			__('Footer', 'gdl_back_office')=>'gdl_panel_footer',
			__('Table', 'gdl_back_office')=>'gdl_panel_table',
		...
		__('Slider Setting', 'gdl_back_office') => array(
			...
			__('Elastislide (Slide show)', 'gdl_back_office')=>'gdl_panel_elastislide',
			__('Enable Plugin', 'gdl_back_office')=>'gdl_enable_plugin',
		),
	);
	...
	$goodlayers_element = array(
		...
		'gdl_panel_font' => array(
			__('HEADER FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_header_font', 'default'=>'- Merriweather',
			...
			__('STUNNING TEXT FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_stunning_text_font', 'default'=>'- Merriweather',
		...
		'gdl_panel_logo' => array( 
			...
			__('LOGO TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_top_margin','default'=>'16',
			...
			__('LOGO BOTTOM MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_bottom_margin','default'=>'36',
			...
			__('SEARCH TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_search_top_margin','default'=>'28'), 				
		),
		...
		'gdl_panel_top_navigation' => array( 
			...
			__('TOP NAVIGATION RIGHT ICON', 'gdl_back_office')=>array('type'=>'upload','name'=>THEME_SHORT_NAME.'_top_navigation_right_icon'),
		...
		'gdl_panel_social_network' => array( 
			__('SOCIAL ICON TYPE','gdl_back_office')=>array('type'=>'combobox', 'name'=>THEME_SHORT_NAME.'_social_icon_type',  
		...
		'gdl_panel_copyright_area' => array( 
			__('FOOTER TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_footer_top_margin','default'=>'-100'),
			__('CONTAINER MIN HEIGHT', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_container_min_height','default'=>'200'),
		...
		'gdl_panel_footer_slide_show' => array(
			__('ENABLE SLIDE SHOW', 'gdl_back_office')=>array('type'=>'radioenabled','name'=>THEME_SHORT_NAME.'_footer_enable_slideshow', 'default'=>'disable'),
			__('SHOW ONLY HOMEPAGE', 'gdl_back_office')=>array('type'=>'radioenabled','name'=>THEME_SHORT_NAME.'_footer_slideshow_frontpage'),
			__('HEADER TITLE', 'gdl_back_office')=>array('type'=>'inputtext', 'name'=>THEME_SHORT_NAME.'_footer_slideshow_header_title'),
			__('HEADER ICON', 'gdl_back_office')=>array('type'=>'upload', 'name'=>THEME_SHORT_NAME.'_footer_slideshow_header_icon'),
			__('CHOOSE GALLERY', 'gdl_back_office')=>array('type'=>'combobox','name'=>THEME_SHORT_NAME.'_footer_gallery_slideshow', 'options'=>get_title_list( 'gallery' )),
		),
		...
		'gdl_panel_navigation' => array(
			__('TOP NAVIGATION TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_navigation_text','default'=>'#7c7c7c',),		
			__('MAIN NAVIGATION GRADIENT', 'gdl_back_office')=>array('type'=>'radioenabled','name'=>THEME_SHORT_NAME.'_main_navigation_gradient'),
			__('MAIN NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_background','default'=>'#66a3bf'),
			__('SUB MENU NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_background','default'=>'#ffffff'),
			__('MAIN NAVIGATION BORDER LEFT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_border_left','default'=>'#4c87a1',
			...
			__('MAIN NAVIGATION BORDER RIGHT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_border_right','default'=>'#7eadc3',
			...
			__('MAIN NAVIGATION BORDER TOP/BOTTOM', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_border_top_bottom','default'=>'#5391ae',
				'description'=>'This color effects the top border, buttom border and submenu border of the main navigation.'),
			__('SUB NAVIGATION BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_border','default'=>'#e9e9e9'),
			...
			__('MAIN NAVIGATION TEXT HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_hover','default'=>'#ededed',
			...
			__('SUB NAVIGATION TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text','default'=>'#999999',
				'description'=>'This is the text color of the main navigation in the normal state.'),
			__('SUB NAVIGATION TEXT HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text_hover','default'=>'#666666'),
			__('MAIN NAVIGATION TEXT CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_current','default'=>'#ededed',
		...
		'gdl_panel_top_search' => array(
			__('TOP SEARCH BOX BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_box_background','default'=>'#ffffff'),
			__('TOP SEARCH BOX BORDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_box_border','default'=>'#e3e3e3',
				'description'=>'This is the inner shadow color of search text box. Change it to match with background color.'),
			__('TOP SEARCH BOX TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_box_text','default'=>'#b7b7b7'),
			__('TOP SEARCH BUTTON BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_button_background','default'=>'#5996b2'),
			__('TOP SEARCH BUTTON TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_button_text_color','default'=>'#ffffff'),
			__('SEARCH (COURSE) BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_course_background','default'=>'#f7f7f7'),
			__('SEARCH (COURSE) BOX BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_course_box_background','default'=>'#ffffff'),
			__('SEARCH (COURSE) BOX BORDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_course_box_border','default'=>'#e3e3e3'),
			__('SEARCH (COURSE) BOX TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_course_box_text','default'=>'#b7b7b7'),		
			__('SEARCH (COURSE) BUTTON BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_course_button_background','default'=>'#5996b2'),
			__('SEARCH (COURSE) BUTTON TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_course_button_text_color','default'=>'#ffffff'),			
		),
		...
		'gdl_panel_body' => array(	
			...
			__('HEADER TITLE BOTTOM LINE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_header_title_bottom_line','default'=>'#65A2BE'),			
			__('CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_caption_color','default'=>'#9a9a9a'),
			__('CONTENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_content_color','default'=>'#666666'),
			__('CONTENT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_content_background','default'=>'#ffffff'),
			__('CONTENT CONTAINER SHADOW COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_content_container_shadow_color','default'=>'#e5e5e5'),
			__('CONTENT BOTTOM LINE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_content_bottom_line','default'=>'#d2d2d2'),
			__('HEADER ICON BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_header_icon_background','default'=>'#64A5C4'),
			__('BODY BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_body_background','default'=>'#f5f5f5',
			...
			__('LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_color','default'=>'#2a84ae',
				'description'=>'This color effects all of the link color in this theme.'),
			__('LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_hover_color','default'=>'#2a84ae',
			...
			__('ELEMENTS SHADOW', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_elements_shadow','default'=>'#ececec',
				'description'=>'This color changes the elements shadow color in the container, including button and price item.'),
			__('SIDEBAR TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_title_color','default'=>'#494949'),
			__('SIDEBAR TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_title_background','default'=>'#f5f5f5'),
			__('SIDEBAR TITLE TOP BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_title_top_border','default'=>'#64a5c4'),
			),
			
		'gdl_panel_footer' => array(	
			__('FOOTER ICON TYPE', 'gdl_back_office')=>array('type'=>'combobox','name'=>THEME_SHORT_NAME.'_footer_icon_type','options'=>array('0'=>'light','1'=>'dark'),'default'=>'dark',
				'description' =>'There are two icon types in this theme, dark and light, you can choose it to display on footer as you want.'),
			__('FOOTER LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_color','default'=>'#475d68',
				'description'=>'This color changes all of the link color inside footer in normal state.'),
			__('FOOTER LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_hover_color','default'=>'#5e737d',
			...
			__('FOOTER CONTENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_content_color','default'=>'#ffffff'),	
			__('FOOTER CONTENT INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_content_info_color','default'=>'#d0e4ed',
				'description' =>'The content info is the color of the post date( in post/portfolio widget ) and twitter widget'),	
			__('FOOTER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_background','default'=>'#64a5c4'),
			...
			__('FOOTER DIVIDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_divider_color', 'default'=>'#5f92ab'),
			__('FOOTER INPUT BOX TEXT', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_text', 'default'=>'#ffffff',
				'description' =>'This footer input box comes from search widget and contact form widget, you can change it to fit theme styles.'),
			__('FOOTER INPUT BOX BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_background', 'default'=>'#6392ab'),
			__('FOOTER INPUT BOX BORDER', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_border', 'default'=>'#60737d'),
			__('FOOTER BUTTON COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_button_color', 'default'=>'#ffffff',
				'description' =>'This color is for the submit button of contact widget.'),
			__('FOOTER BUTTON TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_button_text', 'default'=>'#454545'),
			__('FOOTER FRAME BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_frame_background', 'default'=>'#527485',
				'description' =>'Frame is the elements that wrap post/portfolio(widget) thumbnail.'),
			__('FOOTER FRAME BORDER', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_frame_border', 'default'=>'#385766'),
			__('COPYRIGHT TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_copyright_text', 'default'=>'#ffffff'),
		),
		
		'gdl_panel_table' => array(
			...
			__('COURSE TABLE BORDER (TABLE TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_course_table_border','default'=>'#e5e5e5'),
			__('COURSE TABLE TITLE TEXT COLOR (TH TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_course_table_text_title','default'=>'#404040'),
			__('COURSE TABLE TITLE BACKGROUND (TH TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_course_table_title_background','default'=>'#f2f2f2'),					
			__('COURSE ODD ROW BACKGROUND (TD TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_course_odd_row_background','default'=>'#ffffff'),					
			__('COURSE ODD ROW TEXT COLOR (TD TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_course_odd_row_color','default'=>'#9e9e9e'),					
			__('COURSE ODD ROW TEXT LINK (TD TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_course_odd_row_link_color','default'=>'#9e9e9e'),					
			__('COURSE EVEN ROW BACKGROUND (TD TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_course_even_row_background','default'=>'#f9f9f9'),					
			__('COURSE EVEN ROW TEXT COLOR (TD TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_course_even_row_color','default'=>'#9e9e9e'),					
			__('COURSE EVEN ROW TEXT LINK (TD TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_course_even_row_link_color','default'=>'#9e9e9e'),					
		),
		...
		'gdl_panel_slider' => array(
			...
			__('SLIDER CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_caption_color','default'=>'#bbbbbb'),		
			__('BOTTOM SLIDER RIGHT BG', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_bottom_slider_right_bg','default'=>'#3f93b9'),		
		),
			
		'gdl_panel_blog_port' => array(
			__('PORT TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_color','default'=>'#2A84AE',
				'description'=>'This is the portfolio thumbnail title color.'),
			__('PORT TITLE HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_hover_color','default'=>'#2A84AE',
				'description'=>'This is the portfolio thumbnail title color in "hover" state.'),
			__('BLOG TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_color','default'=>'#338db7',
				'description'=>'This is the blog thumbnail title color except the blog in WIDGET style.'),
			__('BLOG TITLE HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_hover_color','default'=>'#338db7',
				'description'=>'This is the blog thumbnail title color in "hover" state.'),
			__('BLOG INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_info_color','default'=>'#aaaaaa',
				'description'=>"This is the blog informateion color. It's include the color of blog date, blog comments number and blog author."),
			__('BLOG (WIDGET STYLE) TITLE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_widget_title_color','default'=>'#338db7'),
			__('BLOG (WIDGET STYLE) INFO', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_widget_info_color','default'=>'#9e9e9e'),
			...
			__('BLOG DATE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_date_background','default'=>'#65a1bd'),
			__('BLOG DATE TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_date_text_color','default'=>'#ffffff'),
		...
		'gdl_panel_stunning_text' => array(
			...
			__('STUNNING TEXT BUTTON BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_button_background','default'=>'#2a84ae',
		...
		'gdl_panel_price_item' => array(
			...
			__('BEST PRICE TEXT COLOR', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_item_best_price_color', 'default'=>'#66a3bf',
		...
		'gdl_panel_blog_port_translator' => array(
			...
			__('POSTED ON (BLOG WIDGET)', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_translator_posted_on','default'=>'Posted on'),
		),
		...
		'gdl_panel_nivo_slider' => array(
			...
			__('PAUSE TIME', 'gdl_back_office')=>array('type'=>'inputtext','oldname'=>'pauseTime','name'=>THEME_SHORT_NAME.'_nivo_slider_pause_time','default'=>'8000',
				'description'=>'This option is the pause time of each slider.'),
			__('CAPTION OPACITY', 'gdl_back_office')=>array('type'=>'inputtext','oldname'=>'captionOpacity','name'=>THEME_SHORT_NAME.'_nivo_slider_caption_opacity','default'=>'0.68'),
		),
		...
		'gdl_panel_flex_slider' => array(
			...
			__('ANIMATION SPEED', 'gdl_back_office')=>array('type'=>'inputtext','oldname'=>'animationDuration','name'=>THEME_SHORT_NAME.'_flex_slider_animation_speed','default'=>'600',
				'description'=>'This is the animation speed during the change of each slide.'),
			__('PAUSE TIME', 'gdl_back_office')=>array('type'=>'inputtext','oldname'=>'slideshowSpeed','name'=>THEME_SHORT_NAME.'_flex_slider_pause_time','default'=>'8000',
				'description'=>'This option is the pause time of each slider.'),
		...
		'gdl_panel_anything_slider' => array(
			...
			__('ANIMATION SPEED', 'gdl_back_office')=>array('type'=>'inputtext','oldname'=>'animationTime','name'=>THEME_SHORT_NAME.'_anything_slider_animation_speed','default'=>'600',
				'description'=>'This is the animation speed during the change of each slide.'),
			__('PAUSE TIME', 'gdl_back_office')=>array('type'=>'inputtext','oldname'=>'delay','name'=>THEME_SHORT_NAME.'_anything_slider_pause_time','default'=>'8000',
				'description'=>'This option is the pause time of each slider.'),
		),
		...
		'gdl_panel_elastislide' => array(
			...
			__('MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','oldname'=>'margin','name'=>THEME_SHORT_NAME.'_elastislide_margin','default'=>30),
		),
		
		'gdl_enable_plugin' => array(
			__('ENBALE TWITTER CAROUSEL(SHORTCODE)')=>array('type'=>'radioenabled', 'name'=>THEME_SHORT_NAME.'_enable_twitter_carousel'),
		),
