...
<?php endif; ?>
			...
			<p><a id="submit" class="<?php echo apply_filters( 'theme_css_class', 'button' );?> medium white" href="#" onclick="jQuery('#commentform').submit();return false;"><span><?php _e('Post Comment','striking_front');?></span></a><?php comment_id_fields(); ?></p>
