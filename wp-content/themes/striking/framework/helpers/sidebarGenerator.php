	...
	function get_sidebar($post_id){
		...
		if(theme_get_option('advance', 'woocommerce')){
			if(is_singular( array('product') )){
				$custom = theme_get_option('advance','woocommerce_product_sidebar');
				if(!empty($custom)){
					$sidebar = $custom;
				}
			}
			if(function_exists('is_post_type_archive')){
				if(is_post_type_archive('product')){
					$custom = theme_get_option('advance','woocommerce_shop_sidebar');
					if(!empty($custom)){
						$sidebar = $custom;
					}else{
						unset($sidebar);
			...
			if(is_tax( 'product_cat' )){
				$custom = theme_get_option('advance','woocommerce_cat_sidebar');
				if(!empty($custom)){
					$sidebar = $custom;
				}else{
					unset($sidebar);
			...
			if(is_tax( 'product_tag' )){
				$custom = theme_get_option('advance','woocommerce_tag_sidebar');
				if(!empty($custom)){
					$sidebar = $custom;
				}else{
					unset($sidebar);
